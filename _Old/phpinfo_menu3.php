...
<body>
    ...
    <nav class="menu">
    <ul>
        <li> <a href="?type=all">All Info</a> </li>
        <li> <a href="?type=general">General</a> </li>
        <li> <a href="?type=configuration">Configuration</a> </li>
        <li> <a href="?type=modules">Modules</a> </li>
        <li> <a href="?type=environment">Environment</a> </li>
        <li> <a href="?type=credits">Credits</a> </li>
        <li> <a href="?type=variables">Variables</a> </li>
        <li> <a href="?type=license">License</a> </li>
            <!-- Call JavaScript Theme Toggle -->
            <link id="theme-stylesheet" rel="stylesheet" href="/css/light.css">
            <li> <button class="ThemeToggle" onclick="toggleTheme()">Toggle Theme </button> </li>
    </ul>
    </nav>';
